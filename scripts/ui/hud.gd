...
@onready var fun_bar: ProgressBar = /StatsContainer/FunContainer/FunBar
@onready var hygiene_bar: ProgressBar = /StatsContainer/HygieneContainer/HygieneBar
@onready var coins_label: Label = /CoinsContainer/CoinsLabel

@onready var room_title_label: Label = /NavContainer/RoomTitleLabel
@onready var btn_left: Button = /NavContainer/BtnLeft
@onready var btn_right: Button = /NavContainer/BtnRight
